export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col justify-between bg-[#0c0c0c] text-white overflow-hidden px-6 sm:px-10 pt-36 pb-16">

      {/* Subtle warm glow */}
      <div className="absolute bottom-0 left-0 w-[500px] h-[350px] opacity-[0.05]"
      ...
      <div className="max-w-7xl mx-auto w-full flex-1 flex flex-col justify-center py-20">
        ...
        <p className="mt-8 text-base text-zinc-500 max-w-sm leading-relaxed font-light">
          World-class production and post for brands that demand excellence — and expect discretion.
        </p>
      </div>

      {/* Bottom bar */}
      <div className="max-w-7xl mx-auto w-full flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 pt-8 border-t border-zinc-900">
