    ...
    <section id="contact" className="py-24 bg-zinc-900">
      <div className="max-w-3xl mx-auto px-6">
        <div className="text-center mb-12">
          <p className="text-xs font-semibold tracking-widest uppercase text-[#ffdd15] mb-3">Contact</p>
          <h2 className="text-4xl sm:text-5xl font-extrabold text-white tracking-tight mb-4">Ready to Start?</h2>
        ...
        {submitted ? (
          <div className="rounded-xl bg-zinc-800 border border-zinc-700 p-12 text-center">
            ...
            <p className="text-gray-400">Thanks for reaching out. A member of our team will be in touch shortly.</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="rounded-xl bg-zinc-800 border border-zinc-700 p-8 sm:p-10 space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                ...
                <input type="text" required placeholder="Jane Smith"
                  className="w-full px-4 py-3 rounded-lg bg-zinc-900 border border-zinc-700 text-white placeholder-zinc-600 focus:outline-none focus:border-[#ffdd15]/50 transition-colors" />
              </div>
              <div>
            ...
            <div>
              ...
              <select className="w-full px-4 py-3 rounded-lg bg-zinc-900 border border-zinc-700 text-white focus:outline-none focus:border-[#ffdd15]/50 transition-colors">
            ...
            <div>
              ...
              <textarea required rows={5} placeholder="Describe your project, timeline, and any specific requirements..."
                className="w-full px-4 py-3 rounded-lg bg-zinc-900 border border-zinc-700 text-white placeholder-zinc-600 focus:outline-none focus:border-[#ffdd15]/50 transition-colors resize-none" />
            </div>
